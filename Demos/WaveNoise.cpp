...
const std::vector< std::string > WaveNoise::mValueTypeNames = {
	"real part", "imaginary part", "modulus (magnitude)", "argument (phase)"
};
 ...
 * ...
 ******************************************************************************/
int WaveNoise::getRecursionLevel() const
{
	return NRec;
}
 ...
 * ...
 ******************************************************************************/
void WaveNoise::setRecursionLevel( int pValue )
{
	NRec = pValue;
}
 ...
 * ...
 ******************************************************************************/
void WaveNoise::setTime( float pValue )
{
	Time = pValue;
}
